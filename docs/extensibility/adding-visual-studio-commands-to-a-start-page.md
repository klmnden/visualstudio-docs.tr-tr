...
```  
 ...
 Bir örnek için bkz [izlenecek yol: Kullanıcı ayarları bir başlangıç sayfasına kaydetme](../extensibility/walkthrough-saving-user-settings-on-a-start-page.md).  
