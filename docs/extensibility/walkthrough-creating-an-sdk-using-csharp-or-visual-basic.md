...
6. Ayrıntılar bölmesinde **WinRT matematik kitaplığı** uzantısı.
...
7. İçinde **başvuru Yöneticisi** iletişim kutusunda **WinRT matematik kitaplığı** onay kutusunu işaretleyin ve ardından **Tamam** düğmesi.
