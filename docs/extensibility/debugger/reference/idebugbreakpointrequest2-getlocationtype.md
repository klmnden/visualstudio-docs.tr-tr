...
`pBPLocationType` [out] Bir değer döndürür [BP_LOCATION_TYPE](../../../extensibility/debugger/reference/bp-location-type.md) bu kesme noktası istek konumunu açıklayan sabit listesi.
