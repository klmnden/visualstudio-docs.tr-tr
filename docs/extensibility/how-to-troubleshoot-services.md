...
1. Hizmet doğru şekilde kayıtlı olup olmadığını görmek için sistem kayıt defterine inceleyin. Daha fazla bilgi için [nasıl yapılır: Bir hizmetin](../extensibility/how-to-provide-a-service.md).
