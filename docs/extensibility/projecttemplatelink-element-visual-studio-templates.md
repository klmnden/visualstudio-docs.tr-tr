...
Yolunu belirtir *.vstemplate* tek bir projede birden fazla projeli bir şablon dosyası.
 ...
 \<VSTemplate > \<TemplateContent > \<ProjectCollection > \<ProjectTemplateLink > - veya - \<VSTemplate > \<TemplateContent > \<ProjectCollection > \<SolutionFolder > \<ProjectTemplateLink >
