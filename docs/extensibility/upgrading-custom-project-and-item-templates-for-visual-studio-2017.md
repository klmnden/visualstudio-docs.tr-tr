...
Proje ve öğe şablonları için ayrı bildirimler oluşturmanız gerekir ve kök şablon dizini için belirtilen yukarıdaki işaret etmelidir. Uzantı ve yerel ayar başına bir bildirim oluşturun.
