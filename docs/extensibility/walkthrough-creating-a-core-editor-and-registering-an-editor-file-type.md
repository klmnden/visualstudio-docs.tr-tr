...
- Başlangıç [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] oluşturup bir [!INCLUDE[csprcs](../data-tools/includes/csprcs_md.md)] adlı VSPackage `MyPackage`açıklandığı gibi [izlenecek yol: Bir menü komutu VSPackage oluşturmak](https://msdn.microsoft.com/library/d699c149-5d1e-47ff-94c7-e1222af02c32).  
