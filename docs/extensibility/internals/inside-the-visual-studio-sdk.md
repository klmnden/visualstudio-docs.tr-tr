...
## <a name="extensibility-architecture"></a>Genişletilebilirlik mimarisi
 ...
 ![Ortam mimari grafiği](../../extensibility/internals/media/environment.gif "ortam") Visual Studio mimarisinin görünümünü genelleştirilmiş
...
> [!NOTE]
> Bu şablonu mimarisi için desteklenmiyor [!INCLUDE[vcprvc](../../code-quality/includes/vcprvc_md.md)] projeleri.
