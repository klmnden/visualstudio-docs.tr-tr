...
|.NET yeni misiniz?|[.NET framework'ün genel bakış](/dotnet/framework/get-started/overview)<br /><br /> [Uygulama Temelleri](/dotnet/standard/application-essentials)<br /><br /> [Visual C# ve Visual Basic ile çalışmaya başlama](../ide/quickstart-visual-basic-console.md)|
