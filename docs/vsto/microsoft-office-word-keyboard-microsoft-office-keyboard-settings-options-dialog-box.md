---
title: Microsoft Office Word Klavyesi, Microsoft Office Klavyesi ayarları, Seçenekler iletişim kutusu
ms.date: 02/02/2017
ms.topic: conceptual
f1_keywords:
 ...
 **Visual Studio klavye düzeni**  
 Word belgesi odağa sahip olsanız bile visual Studio tüm kısayol tuşu komutlarını alır. Örneğin, işlev tuşuna basarsanız **F5** belge odaklanmışken Visual Studio başlatılır, çözümünüzün hata ayıklama.  
  
 **Dinamik klavye düzeni**  
 Odağı aldığında yalnızca visual Studio kısayol tuşu komutlarını alır. Word belgesi odağa sahip olduğunda, sözcük tüm kısayol tuşu komutlarını alır. Örneğin işlev tuşuna basarsanız, **F5** Word belgesi odaklanmışken Word açar **Bul ve Değiştir** iletişim kutusuyla **Git** sekmesi seçili. Basarsanız **F5** Visual Studio, Visual Studio odaklanmışken başlatır, çözümünüzün hata ayıklama.  
