...
## <a name="display-exceptions"></a>Özel durumları görüntüle
 ...
 Varsayılan olarak, Visual Studio değil görünen Just-ın-Time hata ayıklama hataları için Office projeleri ayrıca yapar; Ancak, oluşan hataları görebilmeniz için bu özelliği etkinleştirebilirsiniz. Daha fazla bilgi için [Just-ın-Time debugging in Visual Studio](../debugger/just-in-time-debugging-in-visual-studio.md).
