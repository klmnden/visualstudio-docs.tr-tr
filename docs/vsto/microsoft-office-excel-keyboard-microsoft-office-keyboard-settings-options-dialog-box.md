 ...
 **Visual Studio klavye düzeni**  
 Excel odağa sahip olsanız bile visual Studio tüm kısayol tuşu komutlarını alır. Örneğin, işlev tuşuna basarsanız **F5** Excel odaklanmışken, Visual Studio başlatılır, çözümünüzün hata ayıklama.  
  
 **Dinamik klavye düzeni**  
 Odağı aldığında yalnızca visual Studio kısayol tuşu komutlarını alır. Excel odağa sahip olduğunda, Excel, tüm kısayol tuşu komutlarını alır. Örneğin, işlev tuşuna basarsanız **F5** Excel odaklanmışken Excel açılır **Git** iletişim kutusu. Basarsanız **F5** Visual Studio, Visual Studio odaklanmışken başlatır, çözümünüzün hata ayıklama.  
