...
## <a name="actions-pane-walkthroughs"></a>Eylemler bölmesinde izlenecek yollar  
 ...
 Word belgesinde Eylemler bölmesi oluşturma işlemini gösterir. Eylemler bölmesinden belgeye kullanıcı girişi gönderen iki denetimleri içerir.  
 ...
 Verilere Word eylemler bölmesindeki denetimlere bağlama işlemi gösterilmektedir. Bir SQL Server veritabanındaki tablolar arasında bir ana/ayrıntı ilişkisi denetimleri gösterir.  
 ...
 Eylemler bölmesi Excel'de veri kaynağına bağlı denetimler eklemeyi açıklar.  
...
## <a name="custom-task-pane-walkthroughs"></a>Özel görev bölmesi izlenecek yollar  
 ...
 Konak uygulama kullanıcı denetimi tıklattığında otomatikleştiren bir denetimi içeren bir özel görev bölmesi oluşturma işlemini gösterir.  
 ...
 Kullanıcıların Gizle veya Şerit üzerindeki iki durumlu bir düğmenin tıklayarak özel görev bölmesi oluşturma işlemini gösterir.  
 ...
 Oluşturulan veya Outlook'ta açtığınız her e-posta iletisiyle bir özel görev bölmesi benzersiz bir örneğini görüntülemek nasıl gösterir.  
  
## <a name="ribbon-walkthroughs"></a>Şerit izlenecek yollar  
 [İzlenecek yol: Şerit Tasarımcısını kullanarak özel sekme oluşturma](../vsto/walkthrough-creating-a-custom-tab-by-using-the-ribbon-designer.md)  
 Şerit Tasarımcısını kullanarak özel Şerit sekmesi oluşturma işlemini gösterir. Sekme, Eylemler bölmesi görüntülemek veya gizlemek için kullanılan bir düğme içerir.  
 ...
 Şerit nesne modeline Şerit Office uygulamasına yüklendikten sonra Şerit denetimlerini güncelleştirme için nasıl kullanılacağını gösterir.  
  
 [İzlenecek yol: Şerit XML kullanarak özel sekme oluşturma](../vsto/walkthrough-creating-a-custom-tab-by-using-ribbon-xml.md)  
 Şerit Tasarımcısını kullanmak yerine Şerit XML kullanarak özel Şerit sekmesi oluşturma işlemini gösterir.  
  
## <a name="controls-on-word-documents"></a>Word belgelerindeki denetimler  
 [İzlenecek yol: Belgeye çalışma zamanında, bir VSTO eklentisi için denetimler ekleme](../vsto/walkthrough-adding-controls-to-a-document-at-run-time-in-a-vsto-add-in.md)  
 ...
 Word belge düzeyi özelleştirmesinde onay kutularını kullanarak belge biçimlendirmesini değiştirme işlemi gösterilmektedir.  
...
## <a name="controls-on-excel-worksheets"></a>Excel çalışma sayfası denetimlerini  
 ...
 Bir VSTO eklenti kullanarak çalışma sayfasına denetimler ekleme işlemi gösterilmektedir.  
 ...
 Onay kutularını biçimini değiştirmek için Excel çalışma sayfasındaki kullanmanın temellerini gösterir.  
 ...
 Düğme ve metin kutusu, Excel çalışma sayfalarında kullanmanın temellerini gösterir.  
 ...
 Seçenek düğmelerini kullanarak bir Excel çalışma sayfasında grafik stilleri değiştirme hakkındaki temel bilgileri gösterir.  
