...
|Görev|İlgili içerik|  
|----------|---------------------|  
|**Örnekleme kullanarak uygulama profili**|-   [Örnekleme kullanarak uygulama istatistikleri toplama](../profiling/collecting-application-statistics-for-stand-alone-applications.md)|  
