...
|**ASP.NET Web uygulamalarının profilini oluşturma**|-   [Bellek verileri toplama](../profiling/collecting-memory-data-from-an-aspnet-web-application.md)|  
