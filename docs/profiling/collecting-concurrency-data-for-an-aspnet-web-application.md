---
title: Profiler komut satırında bir ASP.NET Web uygulaması kullanarak için eşzamanlılık verileri toplamak | Microsoft Docs
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
Eşzamanlılık yöntemi [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] kaynak çekişmesi verisini toplamak için profil oluşturma araçları sağlar.

## <a name="common-tasks"></a>Ortak görevler

|Görev|İlgili içerik|
|----------|---------------------|
|Çalışan bir ASP.NET uygulamasına profil oluşturucu ekleme|-   [Nasıl Yapılır: Bir ASP.NET uygulaması için eşzamanlılık verileri toplamak için profil oluşturucu ekleme](../profiling/how-to-attach-the-profiler-to-an-aspnet-web-application-to-collect-concurrency-data-by-using-the-command-line.md)|
...
|Görev|İlgili içerik|
|----------|---------------------|
|**(İstemci) tek başına uygulamaların profilini oluşturma**|-   [Eşzamanlılık verileri toplama](../profiling/collecting-concurrency-data-for-stand-alone-applications.md)|
