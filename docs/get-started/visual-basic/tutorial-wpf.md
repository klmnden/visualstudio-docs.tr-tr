...
ms.locfileid: "53443558"
---
# <a name="tutorial-create-a-simple-application-with-c-or-visual-basic"></a>Öğretici: Basit bir uygulama oluşturacaksınız C# veya Visual Basic
...
1. İçinde **yeni proje** iletişim kutusunda **yüklü** > **Visual Basic** > **Windows Masaüstü** Kategori tıklayın ve ardından **WPF uygulaması (.NET Framework)** şablonu. Projeyi adlandırın **HelloWPFApp**.
