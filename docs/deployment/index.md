...
description: Uygulamaları, hizmetleri ve bileşenleri dağıtmak için Visual Studio 'Yu nasıl kullanacağınızı öğrenin.
ms.custom: seodec18
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bir Web sitesi veya ağ paylaşımına dağıtma</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Linux üzerinde App Service'e dağıtma</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>NuGet paketleri oluşturma ve yayımlama (.NET)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>İçeri aktarma, yayınlama ayarları ve IIS'ye ASP.NET dağıtma</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>ClickOnce (C#) kullanarak masaüstü uygulaması dağıtma</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>C++/CLR uygulaması dağıtma</h3>
                    </div>
                </div>
            </div>
        </div>
