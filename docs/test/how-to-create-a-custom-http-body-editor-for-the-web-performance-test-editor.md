---
title: Özel HTTP Gövde Düzenleyicisi için Web Performans Testi Düzenleyicisi oluşturma
ms.date: 10/19/2016
ms.topic: conceptual
helpviewer_keywords:
...
1. İçinde **hedef Framework'ü** aşağı açılan listesinde, select .NET Framework 4 (veya üzeri).
