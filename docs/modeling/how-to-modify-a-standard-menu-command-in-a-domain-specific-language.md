---
title: DSL içinde standart menü komutunu değiştirme
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
3. Yeni dosyanın, aynı ad alanı ve üretilen kısmi sınıf ada sahip bir kısmi bildirimi yazın. Örneğin:
    ...
    > [!NOTE]
    > Yeni dosyayı oluşturmak için sınıf dosyası şablonu kullandıysanız, hem ad alanı ve sınıf adını düzeltmeniz gerekir.
