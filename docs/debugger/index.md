        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Hata ayıklama teknikleri ve araçları</h3>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Hata ayıklayıcısını kullanmaya başlama</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Hata ayıklama bir C# uygulama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bir Visual Basic uygulamasında hata ayıklama</h3>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Hata ayıklayıcısı ile daha ayrıntılı bilgiler edinin</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Kesme noktaları hakkında daha fazla bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Arabirim Erişimi SDK'sında Hata Ayıklama</h3>
                    </div>
                </div>
            </div>
        </div>
