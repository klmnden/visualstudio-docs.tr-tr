...
- Bir Azure sanal makinesi veya Azure sanal makine ölçek kümesi içinde barındırılan bir üretim uygulamasında hata ayıklamak için bkz: [hata ayıklama Canlı ASP.NET Azure sanal makineler ve Azure sanal makine ölçek kümeleri Snapshot Debugger'ı kullanarak](../debugger/debug-live-azure-virtual-machines.md).

- Azure Kubernetes Service'te barındırılan bir üretim uygulamasında hata ayıklamak için bkz: [ASP.NET Azure Kubernetes hizmeti Snapshot Debugger'ı kullanarak canlı hata ayıklama](../debugger/debug-live-azure-kubernetes.md).
