---
title: Visual Studio hata ayıklayıcısı ile koda gitmek | Microsoft Docs
...
ms.locfileid: "49933774"
---
# <a name="navigate-code-with-the-visual-studio-debugger"></a>Visual Studio hata ayıklayıcısı ile kod gidin
Hata ayıklayıcısı koda gitmek için komutlar ve kısayolları hakkında bilgi edinin ve daha hızlı ve bulun ve uygulamanızdaki sorunları gidermek kolay hale getirir. Hata ayıklayıcı kodda gezinme, ancak uygulamanızın durumunu incelemek veya kendi yürütme akışı hakkında daha fazla bilgi edinin.  
...
## <a name="start-debugging"></a>Hata Ayıklamayı Başlat  
 ...
 ![DBG&#95;Temelleri&#95;sonu&#95;modu](../debugger/media/dbg_basics_break_mode.png "DBG_Basics_Break_Mode")  
...
-   **Kod içinde kesme noktalarını belirleyin**  
     ...
     ![Bir kesme noktası ayarlamak](../debugger/media/dbg_basics_setbreakpoint.png "DBG_Basics_SetBreakpoint")  
...
-   **Tıklanan satıra kadar Çalıştır** 
    ...
    Kodunuzda hata ayıklayıcıda duraklatıldığı sırada bir noktasına çalıştırmak için seçin **yürütme işlemini burada Çalıştır** yeşil ok simgesi (gördüğünüz simgesi bir kod satırının gelindiğinde). Bu, geçici kesme noktaları ayarlama gereğini ortadan kaldırır.
...
-   **Belirtilen ada göre bir işleve çalıştırın**  
     ...
     ![Yeni kesme noktası iletişim kutusu](../debugger/media/dbg_execution_newbreakpoint.png "DBG_Execution_NewBreakpoint")  
...
##  <a name="BKMK_Set_the_next_statement_to_execute"></a> Yürütme akışı değiştirmek için işaretçiyi taşıyın  
 ...
 ![İşaretçiyi taşıma](../debugger/media/dbg_basics_example3.gif "DBG_Basics_Example3")
...
## <a name="BKMK_Restrict_stepping_to_Just_My_Code"></a>Kullanıcı olmayan kod adımla  
