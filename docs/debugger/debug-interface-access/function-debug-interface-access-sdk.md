...
|[IDiaSymbol::get_hasLongJump](../../debugger/debug-interface-access/idiasymbol-get-haslongjump.md)|`BOOL`|`TRUE` işlev içeren bir [longjmp](/cpp/c-runtime-library/reference/longjmp) (yalnızca DIA SDK V8.0 veya üzeri sürümlerde) çağırın.|  
...
|[IDiaSymbol::get_hasSetJump](../../debugger/debug-interface-access/idiasymbol-get-hassetjump.md)|`BOOL`|`TRUE` işlev içeren bir [setjmp](/cpp/c-runtime-library/reference/setjmp) (yalnızca DIA SDK V8.0 veya üzeri sürümlerde) çağırın.|  
