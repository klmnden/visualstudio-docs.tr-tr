...
Visual Studio uzaktan hata ayıklama İzleyicisi (msvsmon) çalıştırmayı denediği kullanıcının yerel bilgisayarda bir hesabı yoksa, bu hata oluşur. Uzak olduğunda eski hata ayıklama altyapısı kullanılarak hata ayıklama bu hata oluşabilir.
