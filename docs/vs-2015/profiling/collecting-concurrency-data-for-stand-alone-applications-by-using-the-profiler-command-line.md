---
title: Profiler komut satırını kullanarak bağımsız uygulamalar için eşzamanlılık verileri toplama | Microsoft Docs
ms.custom: ''
ms.date: 11/15/2016
...
|**Çalışan bir .NET Framework uygulamasına profil oluşturucu ekleme**|-   [Nasıl yapılır: eşzamanlılık verileri toplamak için bir .NET Framework uygulamasına Profiler ekleme](../profiling/how-to-attach-the-profiler-to-a-dotnet-framework-stand-alone-application-to-collect-concurrency-data-by-using-the-command-line.md)|  
|**Çalışan bir C/C++ uygulamasına profil oluşturucu ekleme**|-   [Nasıl yapılır: bir yerel uygulama ve eşzamanlılık verileri toplama için Profiler ekleme](../profiling/how-to-attach-the-profiler-to-a-native-stand-alone-application-and-collect-concurrency-data-by-using-the-command-line.md)|  
...
|**.NET bellek ayırma ve atık koleksiyon profili**|-   [.NET Framework bellek verileri toplama](../profiling/collecting-dotnet-framework-memory-data-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
...
### <a name="profiling-concurrency-issues"></a>Profil oluşturma eşzamanlılık sorunları  
  
|Görev|İlgili içerik|  
|----------|---------------------|  
|**Profil ASP.NET uygulamaları**|-   [Eşzamanlılık verileri toplama](../profiling/collecting-concurrency-data-for-an-aspnet-web-application-using-the-profiler-command-line.md)|  
