...
## <a name="lock-contention-and-serialized-execution"></a>Kilit çakışması ve seri hale getirilmiş yürütme  
 ...
 Daha fazla bilgi için "performans düzeni 1: Kilit çakışması Hazim Shafi içinde ait tanımlama" [paralel performans araçları için Windows](http://go.microsoft.com/fwlink/?LinkID=160569) MSDN blog Web sitesinde blogu.  
