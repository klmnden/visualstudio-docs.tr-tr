...
|Görev|İlgili içerik|  
|----------|---------------------|  
|**İzleme kullanarak bir .NET Framework uygulamasına profil**|-   [Nasıl Yapılır: .NET Bileşenini İzleme ve Ayrıntılı Zamanlama Verileri Toplama](../profiling/how-to-instrument-a-stand-alone-dotnet-framework-component-and-collect-timing-data-with-the-profiler-from-the-command-line.md)|  
|**İzleme kullanarak C/C++ uygulamasına profil**|-   [Nasıl Yapılır: Yerel Bileşeni İzleme ve Ayrıntılı Zamanlama Verileri Toplama](../profiling/how-to-instrument-a-native-stand-alone-component-and-collect-timing-data-with-the-profiler-from-the-command-line.md)|  
...
|Görev|İlgili içerik|  
|----------|---------------------|  
|**Örnekleme kullanarak uygulamaların profilini oluşturma**|-   [Örnekleme kullanarak uygulama istatistikleri toplama](../profiling/collecting-application-statistics-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
|**.NET bellek ayırma ve çöp toplama profil oluşturma**|-   [.NET Framework bellek verileri toplama](../profiling/collecting-dotnet-framework-memory-data-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
|**Kaynak çakışması ve iş parçacığı etkinliği profil oluşturma**|-   [Eşzamanlılık verileri toplama](../profiling/collecting-concurrency-data-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
