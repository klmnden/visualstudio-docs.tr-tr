---
title: LINQ to XML örneği kullanarak WPF verilerini bağlama | Microsoft Docs
ms.date: 11/15/2016
...
|Konu|Açıklama|  
|-----------|-----------------|  
|[Nasıl yapılır: LinqToXmlDataBinding Örneğini Derleme ve Çalıştırma](../designers/how-to-build-and-run-the-linqtoxmldatabinding-example.md)|Bu örnek için Visual Studio projeyi oluşturmak ve doldurmak adım adım yönergeler içerir.|  
