...
## <a name="remarks"></a>Açıklamalar  
 Bu özellik, yürütülebilir dosya dışındaki veri hizalama ile derlendiğinde genellikle ayarlanır. Örneğin, Microsoft C++ derleyici komut satırı seçeneği ile veri hizalama değiştirebilirsiniz /Zp*#* burada *#* bayt değeridir.  
