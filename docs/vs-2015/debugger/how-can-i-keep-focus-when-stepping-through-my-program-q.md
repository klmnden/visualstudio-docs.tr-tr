...
## <a name="solution"></a>Çözüm  
 İkinci bir bilgisayar varsa, uzaktan hata ayıklamayı kullanın. Konakta hata ayıklayıcı çalıştırırken, programınızın uzak bilgisayarda çalışabilir. Daha fazla bilgi için [nasıl yapılır: Uzak bilgisayar seçme](http://msdn.microsoft.com/4332ba8e-2f0b-4f62-b96a-e762b9f3c3ba).  
