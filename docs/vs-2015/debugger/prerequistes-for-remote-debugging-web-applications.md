...
- [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] Uzaktan hata ayıklama bileşenleri hata ayıklaması yapmak istediğiniz sunucuda yüklenmesi gerekir. Daha fazla bilgi için [ayarı yukarı uzaktan hata ayıklama](https://msdn.microsoft.com/library/90f45630-0d26-4698-8c1f-63f85a12db9c).  
