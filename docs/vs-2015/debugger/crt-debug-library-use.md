...
C çalışma zamanı kitaplığı hata ayıklama kapsamlı destek sağlar. CRT hata ayıklama kitaplıklarını birini kullanmak için ile bağlamalısınız [/DEBUG](https://msdn.microsoft.com/library/1af389ae-3f8b-4d76-a087-1cdf861e9103) ve derleme **/MDd**, **/mtd**, veya **/LDd**.  
