...
|   **Toplama**    |             None              |                                                                        **Hiçbiri** (4) - sınıf örnekleri arasındaki genel bir ilişkiyi temsil eder.<br /><br /> **Bileşik** (5) - Bu rol nesne karşıt rolü nesne içerir. Kullanabileceğiniz **bileşik** Bileşik toplama ile bir ilişki oluşturmak için aracı.<br /><br /> **Paylaşılan** (6) - bu rolün nesnede başka bir rolle nesne başvurular içerir. Kullanabileceğiniz **toplama** paylaşılan toplama ile ilişkilendirme oluşturmak için aracı.<br /><br /> Yerel kurala tam yorumu açıktır.                                                                         |
