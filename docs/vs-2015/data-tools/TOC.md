...
##### [<association name\> ilişkisi oluşturulamıyor - özellik türleri eşleşmiyor](cannot-create-an-association-association-name-property-types-do-not-match.md)
...
##### [<association name\> ilişkisi oluşturulamıyor - özellik iki kez listeleniyor](cannot-create-an-association-association-name-property-listed-twice.md)
##### [<object name\> veritabanı nesnesi için şema bilgileri alınamadı](could-not-retrieve-schema-information-for-database-object-object-name.md)
