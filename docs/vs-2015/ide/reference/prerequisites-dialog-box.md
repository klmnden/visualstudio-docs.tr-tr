...
|**Microsoft .NET Framework 4 istemci profili (x86 ve x64)**|.NET Framework 4 istemci profili, istemci uygulamaları hedefleyen tam .NET Framework 4'ün bir alt kümesidir. Bu, bir Windows Presentation Foundation (WPF), Windows Forms, Windows Communication Foundation (WCF) ve ClickOnce özellikleri altkümesini sağlar. Bu hızlı dağıtım senaryolarını WPF, Windows Forms ve konsol uygulamaları için .NET Framework 4 istemci Profili'ni hedefleyen sağlar. Daha fazla bilgi için [.NET Framework istemci profili](https://msdn.microsoft.com/library/f0219919-1f02-4588-8704-327a62fd91f1).|  
...
|**Microsoft Visual F# .NET 2.0 için çalışma zamanı**|Bu paket görsel yükler F# x86 ve x64 işletim geleneksel nesne yönelimli ve buyurgan (yordamsal) programlamanın yanı sıra fonksiyonel programlama için destek sağlayan sistemler için çalışma zamanı kitaplıkları. Bu paket, uygulama veya bileşenleri yazılmışsa görselde yüklenmelidir F# ve .NET Framework 2.0, .NET Framework 3.0 veya .NET Framework 3.5.<br /><br /> Daha fazla bilgi için [ F# dil başvurusu](https://msdn.microsoft.com/library/16b706f8-b5f2-4ff7-b2c1-64df33cd6adf).|  
|**Microsoft Visual F# .NET 4.0 için çalışma zamanı**|Bu paket görsel yükler F# x86 ve x64 işletim geleneksel nesne yönelimli ve buyurgan (yordamsal) programlamanın yanı sıra fonksiyonel programlama için destek sağlayan sistemler için çalışma zamanı kitaplıkları. Bu paket, uygulama veya bileşenleri yazılmışsa görselde yüklenmelidir F# ve .NET Framework 4.<br /><br /> Daha fazla bilgi için [ F# dil başvurusu](https://msdn.microsoft.com/library/16b706f8-b5f2-4ff7-b2c1-64df33cd6adf).|  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [.NET Framework yeniden dağıtma](https://msdn.microsoft.com/a18d0456-fd89-493e-97f4-756505bfe287)   
