...
|**Office çalışma zamanı (x86 ve x64) için Microsoft Visual Studio 2010**|Visual Studio Office geliştirici araçları, Microsoft Office ile özelleştirilmiş iş çözümleri oluşturmak için kullanımı kolay, tümleşik araçlar sunar. Office uygulamaları kullanıcı arabirimi olarak kullanan yönetilen, akıllı istemci çözümleri oluşturabilirsiniz. Araçlar geliştiricilerin dağıtma ve bakımını kolay güvenli çözümler oluşturmasını sağlar.<br /><br /> Daha fazla bilgi için [nasıl yapılır: ClickOnce kullanarak Office çözümü yayımlama](http://msdn.microsoft.com/2b6c247e-bc04-4ce4-bb64-c4e79bb3d5b8).|  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [.NET Framework yeniden dağıtma](http://msdn.microsoft.com/a18d0456-fd89-493e-97f4-756505bfe287)   
