---
title: Ortam Seçenekleri iletişim kutusu | Microsoft Docs
ms.date: 11/15/2016
...
|İleti kutusu göründüğünde özelleştirme ve nasıl **Bul ve Değiştir** penceresinde Hızlı Bul'veya hızlı Değiştir sırasında çalışır ve aynı zamanda otomatik olarak bulma doldurmak ne.|[Bul ve Değiştir, Ortam, Seçenekler İletişim Kutusu](../../ide/reference/find-and-replace-environment-options-dialog-box.md)|  
...
|Ayarları makineler arasında dolaştırmak belirtmek için.|[Eşitlenmiş Ayarlar, Ortam, Seçenekler İletişim Kutusu](../../ide/reference/synchronized-settings-environment-options-dialog-box.md)|  
