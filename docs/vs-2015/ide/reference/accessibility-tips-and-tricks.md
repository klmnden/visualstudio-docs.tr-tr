...
## <a name="hidden-visual-studio-shortcut-key-combinations"></a>Gizli Visual Studio kısayol tuş birleşimleri  
 Environment\Keyboard bölmede Seçenekler iletişim kutusundaki görünmez kısayol tuşları kullanılabilen bazı özellikler vardır. Bu kısayol tuş birleşimleri şunları içerir:  
  
|Özellik|Açıklama|Tuş bileşimi|  
|-------------|-----------------|---------------------|  
|Araç penceresi|Araç kutusu sekmeleri arasında gezinme|**CTRL** + **UPARROW**<br /><br /> and<br /><br /> **CTRL** + **DARALTILDI**|  
