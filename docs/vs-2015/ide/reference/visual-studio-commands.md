---
title: Komutları | Microsoft Docs
ms.custom: ''
ms.date: 11/15/2016
...
|[Çözüm Aç](../../ide/reference/open-solution-command.md)|Varolan bir çözümü açar.|
...
|[Kabuk](../../ide/reference/shell-command.md)|İçinden programları başlatır [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] komutu komut istemi'nden yürüttüğünü artırmadığı.|
