...
## <a name="remarks"></a>Açıklamalar  
 ...
 Bir eklenti bir komut sunarsa, komut satırından eklentiyi başlatmak için bu anahtarı kullanabilirsiniz. Daha fazla bilgi için [nasıl yapılır: Eklenti Yöneticisi'ni kullanarak eklentileri denetleme](http://msdn.microsoft.com/library/4f60444a-cb48-4cdb-8df4-941f6419aeeb).  
