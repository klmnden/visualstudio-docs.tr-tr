...
## <a name="understanding-security"></a>Güvenliği Anlama  
 [Güvenlik](http://msdn.microsoft.com/library/9a9621d7-8883-4a4f-a874-65e8e09e20a6)  
 .NET Framework kod erişim güvenliği, rol tabanlı güvenlik, güvenlik ilkesi ve güvenlik araçları açıklanmaktadır.  
  
 [Her geliştiricinin bilmesi gereken ilk on güvenlik ipucuyla kodunuzu koruyun](http://go.microsoft.com/fwlink/?LinkId=72877)  
