...
ms.locfileid: "49237490"
---
# <a name="tips-and-tricks-for-visual-studio"></a>Visual Studio için İp Uçları ve Püf Noktaları
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

İçinde gezinebileceğiniz [!INCLUDE[vs_dev12](../includes/vs-dev12-md.md)] daha kolay kısayollarını kullanarak bu konuda. Daha fazla genel bilgi için bkz: [ \<PAVEOVER > Visual Studio'daki klavye kısayollarını](http://msdn.microsoft.com/en-us/2e15e27f-296b-4e9c-91e6-d91ea0110a67). Visual Studio erişilebilirlik için en iyi duruma getirme hakkında daha fazla bilgi için bkz. [erişilebilirlik ipuçları ve püf noktaları](../ide/reference/accessibility-tips-and-tricks.md).  
...
## <a name="see-also"></a>Ayrıca Bkz.  
 ...
 [Visual Studio bağlanma hataları](http://connect.microsoft.com/VisualStudio)
