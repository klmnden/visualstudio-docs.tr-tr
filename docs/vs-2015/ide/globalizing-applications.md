...
Genelleştirme, birden çok kültürde bu işlevler bir yazılım ürünü geliştirerek, işlemidir. Bu bölümde, hem Windows Formları ve Web formları sayfaları için geçerlidir.  
