...
ms.locfileid: "68158307"
---
# <a name="using-intellisense"></a>IntelliSense Kullanma
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

IntelliSense özellikleri sayısı için genel bir terimdir: Üyeleri listeleme, parametre bilgisi, hızlı bilgi ve tam sözcük. Bu özellikler, yalnızca birkaç tuş vuruşu ile kullandığınız kod hakkında daha fazla bilgi edinmenize, yazmakta olduğunuz parametreleri izlemenize ve özellik ve yöntem çağrıları eklemenize yardımcı olur.  
...
## <a name="quick-info"></a>Hızlı Bilgi  
 ...
 Hızlı bilgi de kapatabilirsiniz C++ ayarlayarak **Araçlar / Seçenekler / metin düzenleyici/C/C++Gelişmiş/otomatik hızlı bilgi** için `false`.  
