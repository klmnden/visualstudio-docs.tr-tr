...
- Birim Testleri yapının bir parçası olarak bir yapı aracısında çalıştırabilirsiniz.  
  ...
  **SharePoint uygulamalarını test etme**  
  ...
  Yukarıda listelenen özellikleri de birim testleri yazma ve Visual Studio kullanarak SharePoint uygulamaları için tümleştirme testleri sağlar. [!INCLUDE[crabout](../includes/crabout-md.md)] Visual Studio kullanarak SharePoint uygulamaları geliştirmenize nasıl [SharePoint çözümleri oluşturma](https://msdn.microsoft.com/library/4bfb1e59-97c9-4594-93f8-3068b4eb9631), [oluşturma ve hata ayıklama SharePoint çözümleri](https://msdn.microsoft.com/library/c9e7c9ab-4eb3-40cd-a9b9-6c2a896f70ae) ve [doğrulama ve hata ayıklama SharePoint Kod](https://msdn.microsoft.com/library/b5f3bce2-6a51-41b1-a292-9e384bae420c).  
