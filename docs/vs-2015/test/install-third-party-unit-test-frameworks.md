...
3.  İçinde **kategori** listesinde, genişletme **Araçları** düğümünü ve ardından **test**.  
  
4.  Aracı için bir Visual Studio Galerisi sayfaya gitmek için sonuç listesinde bir çerçeve seçin.  
