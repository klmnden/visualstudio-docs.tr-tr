...
##### [İzlenecek yol: Veri Kaynağı Tanımlamak İçin Yapılandırma Dosyası Kullanma](walkthrough-using-a-configuration-file-to-define-a-data-source.md)
...
### [İzlenecek yol: Kodlanmış UI Testi Oluşturma, Düzenleme ve Sürdürme](walkthrough-creating-editing-and-maintaining-a-coded-ui-test.md)
