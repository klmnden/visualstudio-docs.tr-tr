...
Bir XML serileştirme derleme türleri için belirtilen derlemesinde oluşturur. Bu görevi, XML serileştiricisi Oluşturma Aracı (Sgen.exe) sarmalar. Daha fazla bilgi için [XML serileştiricisi Oluşturma Aracı (Sgen.exe)](https://msdn.microsoft.com/library/cc1d1f1c-fb26-4be9-885a-3fe84c81cec6).  
