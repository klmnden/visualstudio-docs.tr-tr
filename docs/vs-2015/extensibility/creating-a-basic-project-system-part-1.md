...
6.  İçinde **özellikleri** penceresinde **derleme eylemi** AssemblyInfo.cs, Program.cs, SimpleProject.ico ve için SimpleProject.myproj **içerik**, kendi ayarlayın **VSIX'e Ekle** özelliklerine **True**.  
