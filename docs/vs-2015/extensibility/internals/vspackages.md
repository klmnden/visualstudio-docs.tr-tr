...
VSPackage genişleten yazılım modülleri olan [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] UI öğeleri, hizmetleri, projeler, düzenleyiciler ve tasarımcılar sağlayarak Tümleşik geliştirme ortamı (IDE).  
