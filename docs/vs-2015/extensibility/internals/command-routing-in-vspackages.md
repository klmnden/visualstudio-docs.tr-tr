...
ms.locfileid: "49279623"
---
# <a name="command-routing-in-vspackages"></a>VSPackage’larda Komut Yönlendirme
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Komut içinde yönlendirilir [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] , bunu yürütüleceğini bağlama göre. Bu, dışa doğru ilk bağlamdan genel bağlamına yönlendirilir.  
