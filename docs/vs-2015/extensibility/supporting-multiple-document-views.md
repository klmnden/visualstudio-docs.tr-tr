...
- Form ve kod görünümü desteği: Farklı görünümlerini sağlamak için düzenleyici kullanmanız gerekir. [!INCLUDE[vbprvb](../includes/vbprvb-md.md)], örneğin, bir form görünümü hem de bir kod görünümü sağlar.  
