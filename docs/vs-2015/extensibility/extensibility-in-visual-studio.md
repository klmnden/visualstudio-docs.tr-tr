...
## <a name="create-your-own-sdks"></a>Kendi SDK'ları oluşturma
 , Paket oluşturun ve kendi platform ve uzantı SDK'ları dağıtmak öğrenin: [Bir yazılım geliştirme seti oluşturma](../extensibility/creating-a-software-development-kit.md).
...
## <a name="azure-sdk"></a>Azure SDK
 Azure SDK'sını etkinleştirme nasıl kaydolacağınızı öğrenin: [Azure SDK'yı etkinleştirme](../extensibility/enabling-the-azure-sdk.md).
