...
## <a name="create-your-own-sdks"></a>Kendi SDK'ları oluşturma  
 Oluşturma, paketleme ve kendi platform ve uzantı SDK'ları dağıtma öğrenin: [yazılım geliştirme seti oluşturma](../extensibility/creating-a-software-development-kit.md).  
...
## <a name="azure-sdk"></a>Azure SDK  
 Azure SDK'sını etkinleştirmek öğrenin: [Azure SDK'sını etkinleştirme](../extensibility/enabling-the-azure-sdk.md).
