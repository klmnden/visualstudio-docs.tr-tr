...
## <a name="ui-contexts"></a>UI bağlamları  
...
## <a name="command-sets-and-properties"></a>Komut ayarlar ve Özellikler  
...
## <a name="component-selector-page-guids"></a>Bileşen Seçici sayfası guid  
