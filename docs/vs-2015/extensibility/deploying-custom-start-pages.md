...
- .Vsix dosyasına yükleyebilirsiniz [Visual Studio Market](https://marketplace.visualstudio.com/) Web sitesi kullanıcılar kullanarak yükleyebilir **Uzantı Yöneticisi**.  
