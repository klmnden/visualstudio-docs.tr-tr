...
## <a name="creating-custom-start-pages"></a>Özel başlangıç sayfaları oluşturma  
 Sıfırdan veya indirilebilir başlangıç sayfası örnek kendi başlangıç sayfanızı hale getirmeyi öğrenin: [bir özel başlangıç sayfası oluşturma](../extensibility/creating-a-custom-start-page.md).  
