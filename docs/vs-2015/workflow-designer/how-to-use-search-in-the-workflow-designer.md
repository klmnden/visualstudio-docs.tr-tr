---
title: 'Nasıl yapılır: İş akışı tasarımcısında aramayı kullanın | Microsoft Docs'
ms.date: 11/15/2016
...
## <a name="find-in-files"></a>Dosyalarda Bul  
 Dosyalarda Bul kullanarak dizeleri XAML dosyaları dahil olmak üzere iş akışı dosyaları bulun.  
