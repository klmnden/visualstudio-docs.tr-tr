...
Bu konuda en son sürümünü şu yolda bulunabilir: [Android için Visual Studio öykünücü sorun giderme](https://docs.microsoft.com/visualstudio/cross-platform/troubleshooting-the-visual-studio-emulator-for-android).  
