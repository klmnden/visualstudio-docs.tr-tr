...
ms.locfileid: "54785106"
---
# <a name="ca0054"></a>CA0054

Özel kural derlemesi geçersiz XML kaynaklara sahip

Geçersiz XML kaynakları kurallarını tanımlayan bir özel kural derlemesi varsa, bu oluşur. Doğru biçimi aşağıdaki gibidir:
