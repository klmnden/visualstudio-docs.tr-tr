...
## <a name="when-to-suppress-warnings"></a>Uyarılar Bastırıldığında
 Öznitelikler, dizi döndüren özellikler içerebilir, ancak koleksiyon döndüren özellikler içeremez. [System.Attribute] () türetilen bir özniteliğin bir özellik için oluşturulan bir uyarıyı bastırmak<!-- TODO: review code entity reference <xref:assetId:///System.Attribute?qualifyHint=False&amp;autoUpgrade=True>  -->) sınıfı. Aksi takdirde, bu kuraldan bir uyarıyı bastırmayın.
