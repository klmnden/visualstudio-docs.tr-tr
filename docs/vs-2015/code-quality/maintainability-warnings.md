...
|[CA1504: Yanıltıcı alan adlarını gözden geçirin](../code-quality/ca1504-review-misleading-field-names.md)|Örnek alan adı "kendisinin" ya da statik adını başlatılır (paylaşılan [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]) alanı "m_" ile başlar.|  
