...
## <a name="cause"></a>Sebep
 Yürütüyorsa [Genişletilebilir Stil Sayfası Dil Dönüşümleri (XSLT)](https://support.microsoft.com/kb/313997) .NET uygulamalarında endpoınt, işlemci olabilir [güvenilmeyen URI başvuruları çözümlemek](http://msdn.microsoft.com/ba3e4d4f-1ee7-4226-a51a-78a1f1b5bd8a) , ifşa hassas saldırganlar, hizmet reddi ve siteler arası saldırıları için önde gelen bilgileri.
