...
## <a name="in-this-section"></a>Bu Bölümde  
 [Nasıl yapılır: Standart kod çözümleme iade ilkeleri güncelle](../code-quality/how-to-create-or-update-standard-code-analysis-check-in-policies.md)  
...
## <a name="related-sections"></a>İlgili Bölümler  
 [Ayarlama ve kalite kapıları](https://msdn.microsoft.com/library/bdc5666e-6cf0-45b2-a0a1-133c3f61e852)  
