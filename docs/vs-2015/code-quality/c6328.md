...
```  
 ...
 `c` oturum genişletilmiş-işaretli olacaktır `int` -37 değerine sahip olduğu için geçerli aralık dışında [isspace](https://msdn.microsoft.com/library/3ac254c4-92aa-4238-882a-3a3fb576cdf5).  
