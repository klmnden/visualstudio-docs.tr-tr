...
ms.locfileid: "54876303"
---
# <a name="quickstart-visual-studio-tools-for-docker"></a>Hızlı Başlangıç: Docker için Visual Studio Araçları

Visual Studio 2017 ile kolayca oluşturun, hata ayıklama ve kapsayıcı ASP.NET Core uygulamaları çalıştırın ve Azure Container Registry (ACR), Docker Hub, Azure App Service veya kendi kapsayıcı kayıt defteri yayımlarsınız. Bu makalede, biz ACR'ye yayınlayacaksınız.
