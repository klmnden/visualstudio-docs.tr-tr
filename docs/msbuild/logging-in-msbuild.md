...
- [Paralel olarak birden çok proje derleme](../msbuild/building-multiple-projects-in-parallel-with-msbuild.md) paralel çalıştırarak daha hızlı birden çok proje nasıl oluşturulduğu açıklanır.