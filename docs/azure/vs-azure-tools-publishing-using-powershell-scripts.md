...
ms.locfileid: "50673884"
---
# <a name="using-windows-powershell-scripts-to-publish-to-dev-and-test-environments"></a>Yayımlamak için geliştirme ve test ortamları için Windows PowerShell betiklerini kullanma
