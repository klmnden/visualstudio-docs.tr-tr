...
ms.locfileid: "71118838"
---
# <a name="step-2-run-your-picture-viewer-app"></a>2\. Adım: Resim görüntüleyici uygulamanızı çalıştırma

Windows Forms bir uygulama projesi oluşturduğunuzda, aslında çalıştıran bir program oluşturursunuz. Bu öğreticide, resim görüntüleyici uygulamanız çok fazla&mdash;değil, ancak. Şimdilik, başlık çubuğunda **Form1** ' i gösteren boş bir pencere görüntüler.
