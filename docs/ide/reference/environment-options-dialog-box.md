...
ms.locfileid: "58790049"
---
# <a name="options-dialog-box-environment"></a>Seçenekler iletişim kutusu: Ortam

Sayfaları kullanabilirsiniz **ortam** klasöründe **seçenekleri** nasıl tümleşik geliştirme ortamı (IDE) belirli öğelerinin görüntülenme ve davranış ayarlamak için iletişim kutusu. Seçerek ortam sayfalarına erişebilirsiniz **Araçları** > **seçenekleri**seçip **ortam**.
...
|Ayarları makineler arasında dolaştırmak belirtmek için.|[Hesapları, ortam, Seçenekler iletişim kutusu](../../ide/reference/accounts-environment-options-dialog-box.md)|
