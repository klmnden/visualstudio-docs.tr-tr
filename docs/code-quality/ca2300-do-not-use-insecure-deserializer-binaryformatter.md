---
title: 'CA2300: Güvenli olmayan seri durumdan çıkarıcının BinaryFormatter kullanmayın'
ms.date: 04/05/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
---
# <a name="ca2300-do-not-use-insecure-deserializer-binaryformatter"></a>CA2300: Güvenli olmayan seri durumdan çıkarıcının BinaryFormatter kullanmayın
