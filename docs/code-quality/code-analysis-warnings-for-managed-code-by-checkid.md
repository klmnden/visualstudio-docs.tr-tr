---
title: Checkıd tarafından yönetilen kod için Visual Studio kod çözümleme uyarıları
ms.date: 11/04/2016
...
|CA2107|[CA2107: Gözden geçirmeyi reddedin ve yalnızca kullanımına izin verin](../code-quality/ca2107-review-deny-and-permit-only-usage.md)|PermitOnly yöntemi ve CodeAccessPermission.Deny güvenlik eylemleri yalnızca .NET Framework güvenliğinin Gelişmiş bir bilgiye sahip olan olanlar tarafından kullanılmalıdır. Bu güvenlik eylemlerini kullanan kod güvenlik incelemesi altından geçmelidir.|
...
|CA2128|[CA2147: Saydam türler güvenlik bildirimlerini kullanmamalıdır](../code-quality/ca2147-transparent-methods-may-not-use-security-asserts.md)|Bu kural, tüm yöntemler ve yüzde 100 saydam veya karma saydam/kritik öneme sahiptir ve tüm bildirimsel veya zorunlu kullanımlarını işaretler derlemedeki türleri analiz eder.|
