---
title: 'CA2220: Sonlandırıcılar taban Sonlandırıcıları çağırmalıdır'
ms.date: 11/04/2016
...
ms.locfileid: "53825402"
---
# <a name="ca2220-finalizers-should-call-base-class-finalizer"></a>CA2220: Sonlandırıcılar taban Sonlandırıcıları çağırmalıdır
