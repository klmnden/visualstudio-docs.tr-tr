...
layout: LandingPage
title: Kod Analizi
description: Visual Studio 2017 kod kalitesini analiz etme için nasıl kullanılacağını öğrenin.
ms.date: 12/03/2018
...
ms.locfileid: "52896776"
---
# <a name="code-analysis-in-visual-studio"></a>Visual Studio Kod Analizi
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Yönetilen kod kalitesini analiz etme</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>C ve C++ kod kalitesini analiz etme</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Kod ölçümleri ile kod bakım durumunu ölçme</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Yönetilen kod çözümleme uyarıları</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>C++ kod çözümleme uyarıları</h3>
                    </div>
                </div>
            </div>
        </div>
