...
| [CA1415: P/Invoke'lar doğru bildirin](../code-quality/ca1415-declare-p-invokes-correctly.md) | Bu kural, hedef yöntem bildirimleri için platform çağırma arar [!INCLUDE[TLA2#tla_win32](../code-quality/includes/tla2sharptla_win32_md.md)] Çakışan işaretçi sahip işlevlerin parametre yapısı ve yönetilen bir işaretçi değil bir <xref:System.Threading.NativeOverlapped?displayProperty=fullName> yapısı. |