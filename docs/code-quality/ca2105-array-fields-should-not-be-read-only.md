...
## <a name="related-rules"></a>İlgili kuralları
 ...
 - [CA2104 : Salt okunur kesilebilir başvuru türleri bildirmeyin](../code-quality/ca2104-do-not-declare-read-only-mutable-reference-types.md) 
