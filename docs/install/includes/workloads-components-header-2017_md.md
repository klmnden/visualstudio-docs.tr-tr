...
Bu kimliklerinin kullanma hakkında daha fazla bilgi için bkz. [Visual Studio 2017'yi yüklemek için komut satırı parametreleri kullanmak](../use-command-line-parameters-to-install-visual-studio.md) sayfası. Ve iş yükü ve Bileşen kimlikleri diğer ürünlere yönelik bir listesi için bkz. [Visual Studio iş yükü ve Bileşen kimlikleri](../workload-and-component-ids.md) sayfası.
