...
[Xamarin](xamarin.md) .NET ile Android, iOS, tvOS, watchOS ve Mac Masaüstü uygulamaları için platformlar arası mobil uygulamalar oluşturmanızı sağlar.
...
Mac uygulamaları ile oluşturabileceğiniz [Xamarin.Mac](https://docs.microsoft.com/xamarin/mac/) Cocoa kullanıcı arabirimi çerçevesi kullanarak ve [Mac üzerinde Xamarin.Forms](https://docs.microsoft.com/xamarin/xamarin-forms/platform/other/mac) kod ve kullanıcı Arabirimi ile diğer platformlarda paylaşan uygulamalar oluşturmak için.
