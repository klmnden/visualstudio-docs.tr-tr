...
Uygulama ayarlarınıza erişmek için Azure portal [https://ms.portal.azure.com/](https://ms.portal.azure.com/)gidin. **Işlevler uygulamalar**' ın altında **işlev uygulamaları** ' nı seçin ve işlevinizin adını vurgulayın:
